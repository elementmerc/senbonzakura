...
# ── subcommands (task 18) ─────────────────────────────────────────────────────────────
def test_the_bare_flag_form_still_abliterates(monkeypatch, past_the_environment_preflights):
...
def test_auto_is_an_alias_for_kageyoshi(monkeypatch, past_the_environment_preflights):
