...
Usage:
    ...
    python tools/packaging/pack_track.py --track ~/track-heldout --out src/senbonzakura/data/default-track.bin
    python tools/packaging/pack_track.py --manifest-only
"""
import argparse
import hashlib
import io
