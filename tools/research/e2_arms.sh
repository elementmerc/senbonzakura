...
# USAGE
#
#   tools/research/e2_arms.sh --model Qwen/Qwen3-1.7B --track track --out runs/e2-qwen3-1.7b
#   tools/research/e2_arms.sh ... --arms stock,single-pass          # a subset
#   tools/research/e2_arms.sh ... --dry-run                         # print the plan, touch nothing
#   tools/research/e2_arms.sh ... --drop-weights                    # artefacts only, for a small disk
#   tools/research/e2_arms.sh ... --probe-n 40 --n 200              # holdout boundary and scored items
#   tools/research/e2_arms.sh ... --max-new 640                     # fix the budget, skipping the probe
#   tools/research/e2_arms.sh ... --no-budget-probe                 # same, keeping the default budget
#
