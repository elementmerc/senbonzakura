...
# USAGE
#
#   tools/packaging/repair_manylinux.sh dist/senbonzakura-<v>-py3-none-linux_x86_64.whl
#   tools/packaging/repair_manylinux.sh <wheel> --skip-runtime-check     # no second container
#
set -euo pipefail
