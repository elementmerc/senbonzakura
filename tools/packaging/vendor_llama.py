...
from a correct one until the moment it matters.
    ...
    python tools/packaging/vendor_llama.py                 # this platform
    python tools/packaging/vendor_llama.py --all           # every platform, for a release build
    python tools/packaging/vendor_llama.py --verify-only   # check what is already here, download nothing
"""
